...
backupRouter.post('/', requireAuth, async (req: AuthedRequest, res) => {
...
backupRouter.get('/', requireAuth, async (req: AuthedRequest, res) => {
  const userId = req.userId!
...
backupRouter.get('/:id', requireAuth, async (req: AuthedRequest, res) => {
  const userId = req.userId!
